...
Lane is a keyboard-first macOS launcher for switching between parallel work "lanes". See `README.md` for the user-facing feature set and `PLAN.md` for the complete design spec (every architectural decision is resolved there — consult it before changing behavior).
